# Standard library and external library imports
...
#    print(attn_mask.shape, attn_bias.shape)
...
class Qwen3RepeatK(Qwen3PreTrainedModel):
    ...
    def forward(
        ...
        if self.debug == 1:
            ...
            print(input_idsr.shape)
            print(attention_maskr.shape)
            self.debug = 0
